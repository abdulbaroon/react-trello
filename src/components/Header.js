...
import { userStateListener } from "@/firebase-config/firebase-methords";
  ...
  return (
    <>
      ...
      <div className="relative bg-white">
        <div className="w-full px-2 mx-auto bg-gray-900 ">
          <div className="flex justify-between items-center border-b-2 bg-gray-900 py-6 md:justify-start md:space-x-10">
            <div className="flex justify-start items-center lg:w-0 lg:flex-1">
              <a href="#">
                <span className="sr-only text-yellow-300">Workflow</span>
                <img
              ...
              <p className=" ms-3 font-extrabold text-3xl text-gray-400">ADAB</p>
            </div>
            ...
            <nav className="hidden md:flex space-x-10">
              ...
              <div className="relative">
                <button
                  type="button"
                  className="group bg-gray-900 rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-white focus:outline-none focus:text-white "
    ...
    */}
        ...
        <div
          className={
            open
              ? "z-10 opacity-100 scale-100  ease-out duration-200 absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"
              : "opacity-0 scale-95 absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"
          }
        >
          <div className="rounded-lg shadow-lg ring-1 ring-gray-200 ring-opacity-5 bg-gray-900 divide-y-2 divide-gray-50">
            <div className="pt-5 pb-6 px-5">
              ...
              <div className="mt-6">
                <nav className="grid gap-y-8 z-50">
                  <a
                    href="#"
